...
import org.hsm.model.hedspi.NewLineListManipulator;
...
public class ContactService {
	...
	public static HedspiObjects<Contact> getContacts() {
		...
		Control.getInstance().getLogger()
				.log(Level.INFO, "Fetch raw data of contacts");
		...
		for (HashMap<String, Object> it : rs) {
			...
			Contact contact = new Contact(ct, note, images, phones, dob, sex,
					first, last, emails, home, district);
