package org.hsm.view.function_window;
...
import org.hsm.view.contact.address.AddressPanel;
import org.hsm.view.help.about.AboutBox;
import org.hsm.view.search.SearchPane;
import org.hsm.view.student.StudentPanel;
...
public class AllFunction extends JFrame implements IView {
	...
	public AllFunction() {
		...
		org.hsm.view.classview.ClassPanel splitPane = new org.hsm.view.classview.ClassPanel();
