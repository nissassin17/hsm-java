...
public class ServiceAll {
	...
	public static void backup(){
		//TODO finding way to backup by jdbc rather than using extenal command. See src/bin/pg_dump/pg_dump.c for document
	}
	...
	public static boolean clearAll() {
		int cnt = CoreService.getInstance().update(new String[]{
				"delete from \"Student\"",
				"delete from \"Class\"",
				"delete from \"Contact\"",
	...
	public static boolean commit(){
		...
		int cnt = CoreService.getInstance().update(queries.toArray(new String[queries.size()]));
